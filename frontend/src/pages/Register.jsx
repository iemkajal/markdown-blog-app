      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="w-full max-w-md bg-white shadow-md rounded-lg p-8">
          <form onSubmit={handleRegister}>
            <div className="font-semibold text-xl items-cente  text-center">
            ...
            <button
              type="submit"
              className="w-full p-2 bg-blue-600 border rounded-md hover:bg-blue-800 duration-300 text-white"
            >
              Register
            </button>
          </form>
