      ...
      >
        ...
        <div className="text-center mt-6">
          <img
            ...
            src={
              ...
              "https://res.cloudinary.com/dgjooywzc/image/upload/v1772096440/q79hjqqg3ftadlme3mr9.jpg"
            }
            alt="profile"
          />
        ...
        <ul className="space-y-6 mx-4 mt-6">
          <button
            ...
            className="w-full px-4 py-2 bg-pink-300 rounded-lg hover:bg-pink-500 transition duration-300"
          >
            MY BLOGS
          </button>
          ...
          <button
            ...
            className="w-full px-4 py-2 bg-purple-300 rounded-lg hover:bg-purple-500 transition duration-300"
          >
            MY PROFILE
          </button>
          ...
          <button
            ...
            className="w-full px-4 py-2 bg-yellow-300 rounded-lg hover:bg-yellow-500 transition duration-300"
          >
            LOGOUT
          </button>
        </ul>
